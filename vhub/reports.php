            ...
            <div class="container-fluid">
                <div class="mb-3">
                    <div class="row align-items-end justify-content-center">
                        ...
                        <div class="col-auto">
                            <div class="d-flex">
                                <button class="btn btn-success btn-sm rounded-0 d-flex align-items-center me-2" id="filter"><span class="material-symbols-outlined">filter_alt</span> Filter</button>
