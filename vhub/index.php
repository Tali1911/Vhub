...
<head>
    ...
    <title><?= ucwords($title) ?> | Vhub</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success bg-gradient fixed-top mb-5" id="topNavBar">
        <div class="container">
        <a class="navbar-brand" href="./">
            <img src="logo.jpeg" width="40" height="40" class="d-inline-block align-top" alt="Kps Vhub" loading="lazy">
    ...
    <footer class="position-fixed bottom-0 w-100 bg-gradient bg-light">
        <div class="lh-1 container py-4">
            <div class="text-center">All rights reserved &copy; <?= date("Y") ?> - Vhub</div>
            <div class="text-center">Developed by:<a href="taliemp1911@gmail.com" class='text-body-tertiary'>taliemp1911</a></div>
        </div>
    </footer>
    ...
    <div class="modal fade" id="expenseModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable rounded-0">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-success rounded-0" form="expense-form">Save</button>
    ...
    <div class="modal fade" id="earningModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable rounded-0">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-success rounded-0" form="earning-form">Save</button>
                <button type="button" class="btn btn-secondary rounded-0" data-bs-dismiss="modal">Close</button>
            </div>
            </div>
        </div>
