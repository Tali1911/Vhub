            ...
            <div class="container-fluid">
                <div class="mb-3">
                    <div class="row align-items-end justify-content-center">
                        ...
                        <div class="col-lg-auto">
                            <button class="btn btn-success btn-sm rounded-0 d-flex align-items-center" id="filter"><span class="material-symbols-outlined">filter_alt</span> Filter</button>
                        </div>
                    </div>
                </div>
                <hr>
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-bordered table-hover table-striped" id="visitorTBL">
                        ...
                        <tbody>
                            <?php 
                            $from = new DateTime($from, new DateTimeZone('Africa/Nairobi'));
                            $from->setTimezone(new DateTimeZone('UTC'));
                            $from = $from->format("Y-m-d");
                            $to = new DateTime($to, new DateTimeZone('Africa/Nairobi'));
                            ...
                            while($row = $visitors_qry->fetchArray()):
                                $date_created = new DateTime($row['date_created'], new DateTimeZone('UTC'));$date_created->setTimezone(new DateTimeZone('Africa/Nairobi'));

                                if($row['date_out']){
                                    $date_out = new DateTime($row['date_out'], new DateTimeZone('UTC'));
                                    $date_out->setTimezone(new DateTimeZone('Africa/Nairobi'));
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <?php endif; ?>
                                        <a class="btn btn-sm btn-outline-success rounded-0 edit_data" href="./?page=manage_visitor&id=<?= $row['visitor_id'] ?>" data-id='<?= $row['visitor_id'] ?>' title="Edit visitor"><span class="material-symbols-outlined">edit</span></a>
