...
if(isset($_GET['id']) && $_GET['id'] > 0){
    ...
    $date_created->setTimezone(new DateTimeZone('Africa/Nairobi'));
            ...
            <div class="container-fluid">
                ...
                <div class="text-center">
                    ...
                    <?php if(isset($data['visitor_id']) && $data['user_id'] == $_SESSION['user_id']): ?>
                        <a href="./?page=manage_visitor&id=<?= $data['visitor_id'] ?>&toview=true" class="btn btn-sm btn-success rounded-0">Edit</a>
